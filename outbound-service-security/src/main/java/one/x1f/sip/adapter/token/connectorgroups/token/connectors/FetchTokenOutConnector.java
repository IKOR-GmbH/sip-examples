package one.x1f.sip.adapter.token.connectorgroups.token.connectors;

import static one.x1f.sip.adapter.token.connectorgroups.token.config.KeycloakConfigurationProperties.*;
import static org.apache.camel.builder.Builder.simple;

import one.x1f.sip.adapter.token.connectorgroups.token.config.KeycloakConfigurationProperties;
