package one.x1f.sip.adapter.secured.scenarios.processes;

import one.x1f.sip.adapter.secured.scenarios.definitions.GetLaureateById;
import one.x1f.sip.adapter.secured.scenarios.definitions.GetNobelPrizeAndLaureateDetails;
import one.x1f.sip.adapter.secured.scenarios.definitions.GetNobelPrizeByYearAndCategory;
...
import one.x1f.sip.adapter.secured.scenarios.models.nobelprize.LaureateBasic;
