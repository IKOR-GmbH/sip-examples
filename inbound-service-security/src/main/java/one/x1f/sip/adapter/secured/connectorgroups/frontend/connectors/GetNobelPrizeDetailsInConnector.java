package one.x1f.sip.adapter.secured.connectorgroups.frontend.connectors;

import one.x1f.sip.adapter.secured.config.NobelPrizeMapper;
import one.x1f.sip.adapter.secured.connectorgroups.frontend.models.NobelPrizeCategory;
import one.x1f.sip.adapter.secured.scenarios.definitions.GetNobelPrizeAndLaureateDetails;
...
import one.x1f.sip.adapter.secured.scenarios.models.response.NobelPrizeResponse;
